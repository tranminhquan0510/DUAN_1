...
<head>
  ...
  <link rel="stylesheet" href="./checkout.css"> <!-- CSS cho form thanh toán -->
</head>
<body>
  <!-- Header -->
   <!-- bắt đầu -->
  ...
  <div class="checkout-page">
    <div class="cart">
      <h1>Thanh Toán</h1>
      <div class="cart-item">
        <img src="./img/24CMAW.QD006_-_IMG_3727-_BE_KAKI.webp" alt="Product 1">
        <div class="item-details">
          <h3>Áo sơ mi dài tay cổ tàu Premium Poplin</h3>
          <p class="price">409.000đ</p>
        </div>
        <div class="quantity">
          <p>Còn 479 sản phẩm</p>
        </div>
    ...
    <div class="summary">
      ...
      <div class="order-info">
        ...
        <p>Đối với các sản phẩm có sẵn, Nhà Xinh sẽ giao hàng trong vòng 2-7 ngày.</p>
      </div>
